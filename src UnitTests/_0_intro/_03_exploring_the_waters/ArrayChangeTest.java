...
class ArrayChangeTest {
    ...
    void test1(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(3,new ArrayChange().arrayChange(testCase.clone()));
    }//void test1(){
    ...
    void test2(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(5,new ArrayChange().arrayChange(testCase.clone()));
    }//void test2(){
    ...
    void test3(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(12,new ArrayChange().arrayChange(testCase.clone()));
    }//void test3(){
    ...
    void test4(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(13,new ArrayChange().arrayChange(testCase.clone()));
    }//void test4(){
    ...
    void test5(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(25559,new ArrayChange().arrayChange(testCase.clone()));
    }//void test5(){
    ...
    void test6(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(89510,new ArrayChange().arrayChange(testCase.clone()));
    }//void test6(){
    ...
    void test7(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(2020705,new ArrayChange().arrayChange(testCase.clone()));
    }//void test7(){
    ...
    void test8(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(737073,new ArrayChange().arrayChange(testCase.clone()));
    }//void test8(){
    ...
    void test9(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(2199614,new ArrayChange().arrayChange(testCase.clone()));
    }//void test9(){
    ...
    void test10(){
        ...
        assertTimeout(Duration.ofSeconds(3),()->
                (new ArrayChange().arrayChange(testCase.clone())));
        assertEquals(7097995,new ArrayChange().arrayChange(testCase.clone()));
    }//void test10(){
}//class ArrayChangeTest {